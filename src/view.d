...
immutable string DDHX_VERSION   = "0.12.0"~DEBUG;
/// Build information
...
{
    /// Update the entire view panel (address/data/text)
    UVIEW       = 1 << 1,
    ...
    /// Pending message
    UMESSAGE    = 1 << 16,
    /// Editing (of an element) in progress
    UEDITING    = 1 << 17,
    
    /// Update header, view, and status
